...
class sed_tools(shared_tools):
    """Methods for handling sediment transport.

    Sediment transport routines class. Collection of the unique functions associated with the sediment routing.
    ...
    def deposit(self, Vp_dep, px, py):
        ...
        Vp_dep : `float`
            Quantity of sediment being deposited by the sediment parcel

        px : `int`
            x-coordinate associated with the location of deposition

        py : `int`
            y-coordinate associated with the location of deposition
    ...
    def erode(self, Vp_ero, px, py):
        ...
        Vp_ero : `float`
            Quantity of sediment being eroded by the sediment parcel

        px : `int`
            x-coordinate associated with the location of erosion

        py : `int`
            y-coordinate associated with the location of erosion
    ...
    def update_u(self, px, py):
        '''Update the local velocity after erosion or deposition.

        Parameters
        ----------

        px : `int`
            x-coordinate of the location where erosion or deposition occurred

        py : `int`
            y-coordinate of the location where erosion or deposition occurred
    ...
    def sand_dep_ero(self, px, py):
        '''Decide whether to erode or deposit sand at a given location.

        Parameters
        ----------

        px : `int`
            x-coordinate of the current parcel location

        py : `int`
            y-coordinate of the current parcel location
    ...
    def mud_dep_ero(self,px,py):
        '''Decide whether to deposit or erode mud at a given location
    ...
    def sed_parcel(self,theta_sed,sed,px,py):
        ...
        theta_sed : `float`
            Depth dependence (exponent applied to local depth) for sediment routing random walk weight

        sed : `str`
            Type of sediment parcel, `sand` or `mud`

        px : `int`
            x-coordinate associated with the current sediment parcel

        py : `int`
            y-coordinate associated with the current sediment parcel
