...
class water_tools(shared_tools):
    """Methods for handling weighted random walk hydrodynamic solution.

    Collection of the unique functions associated with the water routing.
    ...
    def finalize_water_iteration(self, timestep, iteration):
        ...
        iteration : `int`
            Current iteration of the water routing
        '''
